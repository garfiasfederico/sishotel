...
@section('contenido')
    <h3 class="mb-4 text-xl font-semibold text-gray-500 dark:text-white">Categorias Registrados</h3>
    <div class="flex justify-end">
        <button data-modal-target="default-modal" data-modal-toggle="default-modal" onclick="clearDataCategoria()"
            ...
            type="button">Nueva Categoria</button>
    </div>
                    ...
                    @foreach ($categorias as $key => $categoria)
                        <tr id="categoria{{ $categoria->id }}"
                            ...
                            <td class="items-center px-6 py-4 mr-2">
                                <button data-modal-target="default-modal" data-modal-toggle="default-modal" onclick="setDataCategoria({{$categoria->id}},'{{$categoria->nombre}}')"
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Editar</button>

                                    <button
                                        class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
                                        onclick="deleteCategoria({{ $categoria->id }},'{{ $categoria->nombre }}')" id="btnDeleteNivel{{$categoria->id}}">Eliminar</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <div class="grid grid-cols-6 gap-6">
                        <div class=" col-span-full">
                            ...
                            <label for="first-name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Categoría<span class="text-red-500">*</span></label>
                            <input type="text" name="nombre" id="nombre"
                                ...
                                <div class="invalid-feedback bg-red-500 text-white w-full text-center rounded-md">
                                    Debe indicar la descripcion de la categoría
                                </div>
                        </div>
                    </div>
                    <!-- Modal footer -->
                    <div class="text-right p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        ...
                        <button type="button" onclick="addCategoria()" id="btnAlmacenaCategoria"
                            class=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                             Almacenar Categoria</button>
